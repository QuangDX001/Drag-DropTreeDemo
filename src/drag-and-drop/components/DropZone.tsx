...
type Collected = { isOver: boolean; canDrop: boolean };
...
export const DropZone: React.FC<Props> = ({
  ...
  const [, drop] = useDrop<DragItemProps, DropZoneProps, Collected>(
    () => ({
      accept: "box",
      drop: () => ({ id, name, level }),
      collect: (monitor) => ({
  ...
  return (
    <div ref={ref} className={`ant-tree-title-wrapper level-${level}`}>
      <div
